...
<x-admin.table 
    ...
    order="true" 
    extrabuttons="true"
    addbutton="{{ route('admin.medicaladvices.create') }}" 
    deletebutton="{{ route('admin.medicaladvices.deleteAll') }}" 
    :searchArray="[
        'title' => [
            'input_type' => 'text' , 
...
@section('js')
    ...
    @include('admin.shared.filter_js' , [ 'index_route' => url('admin/medicaladvices')])
@endsection
