        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{__('admin.add') . ' ' . __('admin.medicaladvice')}}</h4>
                </div>
                <div class="card-content">
                    <div class="card-body">
                        <form  method="POST" action="{{route('admin.medicaladvices.store')}}" class="store form-horizontal" novalidate>
                            @csrf
                            <div class="form-body">
                                <div class="row">


                                    @include('admin.shared.inputs.createInputs')
...
@section('js')
    ...
    @foreach ($inputs as $input)
        @if($input['input'] == 'map')
            @include('admin.shared.inputs.map' , ['draggable' => true])
            @break
        @endif
    @endforeach
