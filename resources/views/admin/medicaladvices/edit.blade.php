        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{__('admin.update') . ' ' . __('admin.medicaladvice')}}</h4>
                </div>
                <div class="card-content">
                    <div class="card-body">
                        <form  method="POST" action="{{route('admin.medicaladvices.update' , ['id' => $item->id])}}" class="store form-horizontal" novalidate>
                            @csrf
                            @method('PUT')
