        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{__('admin.update') . ' ' . __('admin.pharmacies')}}</h4>
                </div>
                <div class="card-content">
                    <div class="card-body">
                        <form  method="POST" action="{{route('admin.pharmacyBranch.updateBranch' , ['id' => $row->id])}}" class="store form-horizontal" novalidate>
                            @csrf
                            @method('PUT')
                            <div class="form-body">
                                ...
                                <div class="row">
                                    ...
                                    <input type="hidden" name="pharmacist_id" value="{{ $row->pharmacist_id }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="address" name="address" class="form-control"
                                                    placeholder="{{ __('admin.address') }}" value="{{$row->address}}" required
                                                    data-validation-required-message="{{ __('admin.this_field_is_required') }}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="number" name="comerical_record" value="{{$row->comerical_record}}" class="form-control"
                                    ...
                                    <div class="col-md-12 col-12 ">
                                        <div class="form-group  pl-5 pr-5 mt-4 position-relative">
                                            ...
                                            <input type="hidden" id="lng" name="lng" value="{{$row->lat}}">
                                        </div>
                                    </div>
...
<script>
            $(document).on('click','.delete-image',function(e){
                ...
                $.ajax({
                    url: '{{url("admin/pharmacies/delete-image/")}}' + '/' +$(this).data('id') ,
                    method: 'delete',
                    data: {},
                    dataType:'json',
                    success: (response) => {
    ...
    <script>
        ...
        function addTime() {
            let time = '<div class="times-cont">' +
                '<div class="container time m-auto">' +
                '<div class="row  ">' +
                '<div class="col-md  p-1">' +
                '<label class="bold">{{ __('admin.day') }}</label>' +
                '<select name="days[]" class="form-control border no-arrow">' +
                ...
                '<div class="col-md  p-1">' +
                '<label class="bold">{{ __('admin.from') }} </label>' +
                '<input type="time"  class="form-control border round5 w-100" name="from[]" id="">' +
                '</div>' +

                '<div class="col-md  p-1">' +
                '<label class="bold">{{ __('admin.to') }}</label>' +
                '<input type="time" class="form-control border round5 w-100" name="to[]" id="">' +
                '</div>' +

                '<div class="col-md-1  p-1">' +
                '<div class="d-flex align-items-center flex-column">' +
                '<label class="bold sn" style="color: #fff;"></label>' +
                '<a class="button-error material-button" onclick="removeTime(this)" ><i class="fa fa-times"></i></a>' +
                '</div>' +
                '</div>' +
                '</div>' +
                '</div>' +
