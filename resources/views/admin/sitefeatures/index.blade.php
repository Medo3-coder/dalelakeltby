...
<x-admin.table 
    ...
    order="true" 
    extrabuttons="true"
    addbutton="{{ route('admin.sitefeatures.create') }}" 
    deletebutton="{{ route('admin.sitefeatures.deleteAll') }}" 
    :searchArray="[
        'title' => [
            'input_type' => 'text' , 
...
@section('js')
    ...
    @include('admin.shared.filter_js' , [ 'index_route' => url('admin/sitefeatures')])
@endsection
