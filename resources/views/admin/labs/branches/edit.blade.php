            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form method="POST" action="{{ route('admin.lab.Branch.update', ['id' => $row->id]) }}"
                                            ...
                                            <div class="dropBox1">
                                                <div class="textCenter">
                                                    <div class="imagesUploadBlock">
                                                        ...
                                                        <div class="uploadedBlock">
                                                            <img src="{{ $row->opening_certificate_image }}">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="file" class="form-control" value="{{$row->OpeningCertificatePdf ?? ''}}" name="opening_certificate_pdf"
...
@section('js')
    ...
    <script>
        $(document).on('click','.delete-image',function(e){
            ...
            $.ajax({
                url: '{{url("admin/lab/delete-image/")}}' + '/' +$(this).data('id') ,
                method: 'delete',
                data: {},
                dataType:'json',
                success: (response) => {
