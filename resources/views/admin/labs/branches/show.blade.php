            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{ __('admin.view') . ' ' . __('admin.branch') }}</h4>
                    </div>
                            ...
                            <form class="show form-horizontal">
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        ...
                                        {{-- <label for="first-name-column">{{ __('admin.branch_image') }}</label> --}}
                                        <div class="col-2">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="dropBox">
                                                <div class="textCenter">
                                                    <div class="imagesUploadBlock">
                                                        ...
                                                        <div class="uploadedBlock">
                                                            <img src="{{$row->OpeningCertificateImage}}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <label
                                                for="first-name-column">{{ __('admin.opening_certificate_pdf') }}</label>
                                            <div class="controls">
                                                <a   href="{{$row->OpeningCertificatePdf ?? ''}}" download> <i class="feather icon-arrow-down">  </i></a>
