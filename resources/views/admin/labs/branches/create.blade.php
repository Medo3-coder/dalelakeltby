            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{ __('admin.add') . ' ' . __('admin.branch') }}</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <form method="POST" action="{{ route('admin.lab.Branch.store') }}"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="text-center mb-3">
                                                        <small>{{ __('admin.add_lab_image') }}<span
                                                    ...
                                                    <div class="dropBox1">
                                                        <div class="textCenter">
                                                            <div class="imagesUploadBlock">
                                                                <label class="uploadImg">
                                                                    <span><i class="feather icon-image"></i></span>
                                                                    <input type="file" accept="image/*" name="opening_certificate_image"
                                                                        class="imageUploader">
                                                                </label>
                                                            </div>
                                                            <div class="col">
                                                                <h6 class="bold font14">{{ __('admin.opening_certificate_image') }}
                                                                </h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <input type="file" class="form-control" name="opening_certificate_pdf"
                                                                placeholder="{{ __('admin.opening_certificate_pdf') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="number" name="comerical_record" class="form-control"
                                                                placeholder="{{ __('admin.record_number') }}" required
