...
<x-admin.table 
    ...
    order="true" 
    extrabuttons="true"
    addbutton="{{ route('admin.labs.create') }}" 
    deletebutton="{{ route('admin.labs.deleteAll') }}" 
    :searchArray="[
        'name' => [
            'input_type' => 'text' , 
        ...
        'identity_id' => [
            'input_type' => 'text' , 
            'input_name' => __('admin.identity_id') , 
        ] ,
...
@section('js')
    ...
    @include('admin.shared.filter_js' , [ 'index_route' => url('admin/labs/'.request()->segment(3))])
