                                    ...
                                    @foreach (languages() as $lang)
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    @if ($lang == 'en')
                                                    <input type="text" value="{{$category->getTranslations('name')[$lang] ?? '' }}"  name="name[{{$lang}}]" class="form-control" placeholder="{{__('site.write') . __('site.name_'.$lang)}}">
                                                    @else
                                                    <input type="text" value="{{$category->getTranslations('name')[$lang]}}" name="name[{{$lang}}]" class="form-control" placeholder="{{__('site.write') . __('site.name_'.$lang)}}" required data-validation-required-message="{{__('admin.this_field_is_required')}}" >
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
