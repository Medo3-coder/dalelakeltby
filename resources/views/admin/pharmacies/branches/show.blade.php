                                ...
                                <div class="form-body">
                                    ...
                                    <div class="col-12 p-2">
                                        <div class="form-group map_container">
                                            <input  name="address" id="address" class="form-control address"
                                                   placeholder="{{ __('admin.address') }}" required
                                                    value="{{$row->address}}"
                                                   data-validation-required-message="{{ __('admin.this_field_is_required') }}">
                                            <div id="map" class="map" style="width: 100%;height:250px;">
                                            </div>
                                            <input  type="hidden" class="lat" value="{{$row->lat}}" name="lat"
                                                   id="lat">
                                            <input  type="hidden" class="lng" value="{{$row->lng}}" name="lng"
                                                   id="lng">
                                        </div>
                                    </div>
