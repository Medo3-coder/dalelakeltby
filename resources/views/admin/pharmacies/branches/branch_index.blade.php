...
<x-admin.table 
    ...
    order="true" 
    extrabuttons="true"
    addbutton="{{ route('admin.pharmacyBranch.create' , ['id' => $id] ) }}" 
    {{-- deletebutton="{{ route('admin.pharmacyBranch.deleteAll') }}"  --}}
    :searchArray="[
        ...
        'comerical_record' => [
            'input_type' => 'text' , 
            'input_name' => __('admin.comerical_record') , 
        ] ,
...
@section('js')
    ...
    @include('admin.shared.filter_js' , [ 'index_route' => url('admin/pharmacies/branchs/all/'.$id)])
