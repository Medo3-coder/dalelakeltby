            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{ __('admin.add') . ' ' . __('admin.chranicdiseases') }}</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <form method="POST" action="{{ route('admin.chranicdiseases.store') }}"
                                                ...
                                                @foreach (languages() as $lang)
                                                    <div class="col-md-4 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="controls">
                                                                @if ($lang == 'en')
                                                                <input type="text" name="name[{{ $lang }}]" class="form-control" placeholder="{{ __('site.write') . __('site.name_' . $lang) }}">
                                                                @else
