                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <select name="country_id" class="select2 form-control" required data-validation-required-message="{{__('admin.this_field_is_required')}}" >
                                                            <option value>{{__('admin.choose') . __('admin.country')}}</option>
