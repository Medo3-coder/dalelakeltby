            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form method="POST" action="{{ route('admin.ClinicBranch.store') }}"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                                ...
                                                                <div class="imagesUploadBlock">
                                                                    <label class="uploadImg">
                                                                        ...
                                                                        <input type="file" accept="image/*"
                                                                            name="images[]" class="imageUploader">
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="text-center mb-3">
                                                        <small>{{ __('admin.add_clinic_image') }}<span
                                                ...
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        <label
                                                            for="first-name-column">{{ __('admin.detection_price') }}</label>
                                                        <div class="controls">
                                                ...
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="number" name="record_number" class="form-control"
                                                                        ...
                                                                        <div class="row align-items-center">
                                                                            ...
                                                                            <div class="col-md-1  p-1">
                                                                                <div
                                                                                    ...
                                                                                    <a type="button"
                                                                                        class="button-error material-button d-none "
...
@section('js')
    ...
    <script>
        ...
        $(document).on('click' , '.add-time', function() {
            ...
            clone_div.find('.d-none').removeClass('d-none');
