                        ...
                        <div class="dropBox">
                            <div class="textCenter">
                                <div wire:ignore class="imagesUploadBlock">
                                    ...
                                    @if ($currentPharmacy->image)
                                        <div class="uploadedBlock"><img src="{{ $currentPharmacy->image }}"><button
                        ...
                        <div class="dropBox">
                            <div class="textCenter">
                                <div wire:ignore class="imagesUploadBlock">
                                    ...
                                    @if ($currentPharmacy->identity_image)
                                        <div class="uploadedBlock"><img
                                                src="{{ $currentPharmacy->identity_image }}"><button class="close"><i
        ...
        <div class="col-md-6 col-12">
            <div class="form-group">
                ...
                @if ($graduation_certification_image)
                    ...
                    @elseif($currentPharmacy)
                    <img height="100" src="{{$currentPharmacy->graduation_certification_image}}">
                @endif
            </div>
        ...
        <div class="col-md-6 col-12">
            <div class="form-group">
                ...
                @if ($practice_certification_image)
                    ...
                    @elseif($currentPharmacy)
                    <img height="100" src="{{$currentPharmacy->practice_certification_image}}">
                @endif
            </div>
        ...
        <div class="col-md-6 col-12">
            <div class="form-group">
                ...
                @if ($experience_certification_image)
                    ...
                    @elseif($currentPharmacy)
                    <img height="100" src="{{$currentPharmacy->experience_certification_image}}">
                @endif
            </div>
    ...
    <div class="row setup-content {{ $currentStep != 3 ? 'display-none' : '' }}" id="step-3">
        <div class="col-12">
            ...
            @foreach ($currentBranches as $key => $branch)
                <div {{ in_array($branch['id'], $deletedBranches) ? 'style=opacity:.3' : '' }}
                    ...
                    <div id="headingCollapserr{{ $key . 'current' }}" class="card-header pb-2" data-toggle="collapse"
                        role="button" data-target="#collapseww{{ $key . 'current' }}" aria-expanded="false"
        ...
        <div class="col-6">
            <div class="form-group">
                <label for="first-name-column">{{ __('admin.name') }}</label>
                <div class="controls">
                    <input wire:model="pharmacyName" type="text" name="name" class="form-control"
