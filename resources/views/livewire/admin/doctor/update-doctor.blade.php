                    ...
                    @if ($category_id && $category && count($category->childes) > 0)
                        <div class="col-md-6 col-6">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <select wire:model="speciality_id" name="block" class="select2 form-control"
                                        required
                                        data-validation-required-message="{{ __('admin.this_field_is_required') }}">
    ...
    <div class="row setup-content {{ $currentStep != 2 ? 'display-none' : '' }}" id="step-2">
        ...
        <div class="col-md-6 col-12">
            <div class="form-group">
                ...
                @elseif($currentDoctor)
                    <img height="100" src="{{ $currentDoctor->graduation_certification_image }}">
                @endif
            </div>
        ...
        <div class="col-md-6 col-12">
            <div class="form-group">
                ...
                @elseif($currentDoctor)
                    <img height="100" src="{{ $currentDoctor->practice_certification_image }}">
                @endif
            </div>
        ...
        <div class="col-md-6 col-12">
            <div class="form-group">
                ...
                @elseif($currentDoctor)
                    <img height="100" src="{{ $currentDoctor->experience_certification_image }}">
                @endif
            </div>
    ...
    <div class="row setup-content {{ $currentStep != 3 ? 'display-none' : '' }}" id="step-3">
        ...
        <div class="col-6">
            <div class="form-group">
                <label for="first-name-column">{{ __('admin.name') }}</label>
                <div class="controls">
                    <input wire:model="clinicName" type="number" name="name" class="form-control"
