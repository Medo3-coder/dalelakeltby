    ...
    <div class="row setup-content {{ $currentStep != 2 ? 'display-none' : '' }}" id="step-2">
        ...
        <div class="col-6">
            <div class="form-group">
                ...
                <div class="controls">
                    <input wire:model="storeName" type="text" name="storeName" class="form-control"
        ...
        <div class="col-md-6 col-12">
            <div class="form-group">
                <div class="controls">
                    ...
                    <input wire:model.defer="opening_certificate_pdf" accept="application/pdf" type="file" class="form-control"
