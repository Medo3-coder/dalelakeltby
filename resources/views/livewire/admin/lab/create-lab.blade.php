<div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <select wire:model="city_id" name="block" class="select2 form-control" required
                                    data-validation-required-message="{{ __('admin.this_field_is_required') }}">
                                    <option  selected>{{ __('admin.select') . ' ' . __('admin.city') }}
                                    </option>
                                    @foreach ($cities as $cityKey => $city)
                                        <option wire:key="city{{ $cityKey }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <select style="width: 20% ; position: absolute; left: 3%;" wire:model="country_code"
                                    ...
                                    data-validation-required-message="{{ __('admin.this_field_is_required') }}">
                                    <option selected>
                                        {{ __('admin.country_code') }}</option>
                                    @foreach ($keys as $key)
                                        <option value="{{ $key->key }}">
                                            {{ $key->key }}</option>
                                    @endforeach
                                </select>
                                <input type="number" minlength="9" maxlength="11" wire:model.lazy="phone"
    ...
    <div class="row setup-content {{ $currentStep != 2 ? 'display-none' : '' }}" id="step-2">
        ...
        {{--  <div class="col-md  p-1">
            <label class="bold">{{ __('admin.city') }}
            </label>

             <select wire:model="city_id" id="" class="form-control border no-arrow ">
                <option selected disabled value="0">{{ __('admin.select_city') }}</option>
        ...
        <div class="row w-100 justify-content-center" wire:loading.remove wire:target="storeLab">
            <button class="btn mx-1 btn-primary nextBtn btn-lg pull-right" type="button"
                wire:click="storeLab">{{ __('admin.add') }}</button>
