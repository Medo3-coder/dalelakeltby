    ...
    <main class="main-sec" id="main">
        <div class="container">
            <div class="side-heading">
                <h6>{{ __('store.edit_product') }}</h6>
                <div class="links-top-to">
                    <a href="{{ route('store.products') }}">{{ __('store.products') }}</a>  /
                    <span class="color-main">{{ __('store.edit_product') }}</span>
                </div>
            </div>
            <form action="{{ route('store.products.update', $product['id']) }}" id="form" method="POST" enctype="multipart/form-data" class="form">
                @csrf
                @method('PUT')
                <input type="hidden" name="group_one_id" value="{{ $product->groupOne()->id }}">
                    ...
                    <div class="card-white">
                        ...
                        <div class="col-12 col-lg-8 flex-add-new mb-4">
                            <div class="right-go-up">
                                <img id="change-profile" class="w-100 img-new-style"  src="{{ $product->image }}" alt="">
                        ...
                        <div class="mb-3 main-inp-cont col-12 col-lg-8">
                            ...
                            <input type="date" id="from" value="{{ $product->groupOne()->from }}" placeholder="{{ __('store.choose') }} {{ __('store.date') }} {{ __('store.from') }}"  aria-invalid="false" name="from" class="default_input">
                                <label class="float__label" for=""
                        ...
                        <div class="mb-3 main-inp-cont col-12 col-lg-8">
                            ...
                            <label class="form__label">
                                <input type="date" id="to" value="{{ $product->groupOne()->to }}" placeholder="{{ __('store.choose') }} {{ __('store.date') }} {{ __('store.to') }}"  aria-invalid="false" name="to" class="default_input">
                                <label class="float__label" for=""
                        ...
                        <div class="mb-3 main-inp-cont col-12 col-lg-8">
                            ...
                            <label class="form__label">
                                <input type="date" id="date_of_supply" placeholder="{{ __('store.choose') }} {{ __('store.date of supply') }}" value="{{ $product->date_of_supply }}"  aria-invalid="false" name="date_of_supply" class="default_input">
                                <label class="float__label" for=""
                        ...
                        <div class="mb-3 main-inp-cont col-12 col-lg-8">
                            ...
                            <select name="category_type" id="category_type" class="default2-select gr">
                                ...
                                <option value="medicine" {{ $product->category_type == 'medicine' ? 'selected' : '' }}>{{ __('store.medicine') }}</option>
                                <option value="equipment" {{ $product->category_type == 'equipment' ? 'selected' : '' }}>{{ __('store.equipment') }}</option>
                            </select>
                        ...
                        <div class="mb-3 main-inp-cont col-12 col-lg-8 activeSubstances">
                            ...
                            <label class="form__label">
                                <input type="text" id="active_substances" value="{{ $product->effective_material }}" placeholder="{{ __('store.write') }} {{ __('store.Active substances') }}"   name="effective_material" class="default_input">
                                <label class="float__label" for=""
                        ...
                        <div class="mb-3 main-inp-cont col-12 col-lg-8">
                            ...
                            <select name="in_stock_type" id="" class="default2-select gr">
                                ...
                                <option value="in"{{ $product->groupOne()->in_stock_type == 'in' ? 'selected' : '' }}>{{ __('store.in') }} {{ __('store.stocked') }}</option>
                                <option value="out"{{ $product->groupOne()->in_stock_type == 'out' ? 'selected' : '' }}>{{ __('store.run out') }} {{ __('store.stocked') }}</option>
                            </select>
                        ...
                        <div class="mb-3 main-inp-cont col-12 col-lg-8">
                            ...
                            <div class="form__label">
                                <input
                                        ...
                                        type="text"
                                        name="in_stock_sku"
                                        value="{{ $product->groupOne()->in_stock_sku}}"
                                        placeholder="{{ __('store.write') }} {{ __('store.SKU (Stock Keeping Unit)') }}"
                                />
                                <label class="float__label" for=""
                        ...
                        <div class="mb-3 main-inp-cont col-12 col-lg-8">
                            ...
                            <select name="available" id="" class="default2-select gr">
                                ...
                                <option value="true" {{ $product->available == 'true' ? 'selected' : '' }}>{{ __('store.available') }}</option>
                                <option value="false" {{ $product->available == 'false' ? 'selected' : '' }}>{{ __('store.Unavailable') }}</option>
                            </select>
                        ...
                        <div class="mb-3 main-inp-cont col-12 col-lg-8">
                            ...
                            <select name="type" id="" class="default2-select gr">
                                ...
                                <option value="simple" {{ $product->type == 'simple' ? 'selected' : '' }}>{{ __('store.basic') }}</option>
                                <option value="multiple" {{ $product->type == 'multiple' ? 'selected' : '' }}>{{ __('store.Multi character') }}</option>
                            </select>
                        ...
                        @foreach (languages() as $lang)
                            ...
                            <label class="form__label">
                              ...
                              >{{ $product->desc ? $product->getTranslation('desc', $lang) : '' }}</textarea>
                        ...
                        <div class="mb-3 main-inp-cont col-12 col-lg-8">
                            ...
                            <div class="uploaded__area" id="filesNext2_cont">
                                @if(count($product->images) > 0)
                                    @foreach($product->images as $image)
                                        <div class="file_">
                                            ...
                                            </a> <div class="btn remove_media" onclick="deleteFile(this ,'230x0w.webp' ,'filesNext2')">
