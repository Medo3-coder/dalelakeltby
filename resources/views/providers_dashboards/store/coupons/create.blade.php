        ...
        <div class="container">
            <div class="side-heading">
                ...
                <div class="links-top-to">
                    ...
                    <span class="color-main">{{ __('store.Add a new discount coupon') }}</span>
                </div>
            </div>
            <form action="{{ route('store.coupons.store') }}" id="form" method="POST" enctype="multipart/form-data" class="form">
                @csrf
                <div class="card-ins">
                    <div class="card-white">
                        <h4 class="font_bold mb-4 spe-border">{{ __('store.New coupon information') }}</h4>
