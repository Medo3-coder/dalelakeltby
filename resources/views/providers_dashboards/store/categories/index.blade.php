    ...
    <main class="main-sec" id="main">
        <div class="container">
            ...
            <div class="side-heading mt-4">
                <h6>{{ __('store.Products categories') }}</h6>
            ...
            <div class="table-top">
                ...
                <div class="select-spe ">
                    ...
                    <div class="inp-date-con  d-flex flex-row" style="margin-bottom: 16px">
                        <a href="{{ route('store.categories.create') }}" class="add_new_test up edit-btn-add"><i class="fa-solid fa-plus"></i></a>
                    </div>
...
@push('js')
    ...
    @include('admin.shared.filter_js' , [ 'index_route' => url('store/categories')])
