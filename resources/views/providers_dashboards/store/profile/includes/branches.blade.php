    ...
    <div class="modal-dialog modal-dialog-spe">
        <div class="modal-content">
            ...
            <div class="modal-body no-border-bottom modal1-spe">
                <h5 class="font-17 font_bold mb-3 ">{{ __('store.Modify the store data') }}</h5>
                <form action="{{ route('store.profile.store.update') }}" method="POST" enctype="multipart/form-data" class="form">
                    @csrf
                    @method('PUT')
                    <div class="add-append">
                        ...
                        <div class="branches">
                            <div class="spe-append-map position-relative ">
                                <div class="mb-3 main-inp-cont">
                                    ...
                                    <div class="form__label">
                                        <input class="default_input" type="text" name="name[]" value="{{ $firstBranch->name }}"  placeholder="{{ __('store.store_name') }}" />
                            ...
                            <div class="mb-3 main-inp-cont">
                                <h6 class="fontBold mainColor font14">{{ __('store.store_address') }}</h6>
                                <div class="form__label">
                                    <input class="default_input" type="text" name="address[]" value="{{ $firstBranch->address }}"  placeholder="{{ __('store.store_address') }}" />
                            ...
                            <div class="maps">
                                <div class="mb-3 main-inp-cont">
                                    <h6 class="fontBold mainColor font14">{{ __('store.store_address_map') }}</h6>
                                    <div class="form__label">
                                        <input readonly class="default_input address" type="text" name="address_map[]" value="{{ $firstBranch->address_map }}"  placeholder="{{ __('store.store_address_map') }}" />
                            ...
                            <div class="mb-3 main-inp-cont">
                                <h6 class="fontBold mainColor font14">{{ __('store.store_record_number') }}</h6>
                                <div class="form__label">
                                    <input class="default_input" name="comerical_record[]" value="{{ $firstBranch->comerical_record }}" type="number"  placeholder="{{ __('store.store_record_number') }}" />
                                    <label class="float__label" for="">{{ __('store.store_record_number_val') }}</label>
                                </div>
                                <div class="error_show error_comerical_record[0]"> </div>
                            </div>
                            <div class="mb-3 main-inp-cont">
                                <h6 class="fontBold mainColor font14">{{ __('store.store_images') }}</h6>
                                <div class="form__label">
                                    <label for="filesNext19_input" class="apload-img-reg">
                                        ...
                                        <div class="img-apload-title">{{ __('store.store_images_val') }}</div>
                                    </label>
                            ...
                            <div class="branches">
                                ...
                                <div class="spe-append-map position-relative ">
                                    ...
                                    <div class="mb-3 main-inp-cont">
                                        ...
                                        <div class="form__label">
                                            <input class="default_input" type="text" name="name[{{ $i}}]" value="{{ $branch->name }}"  placeholder="{{ __('store.branch_name') }}" />
                                            <label class="float__label" for="">{{ __('store.branch_name_val') }}</label>
                                        </div>
                                ...
                                <div class="mb-3 main-inp-cont">
                                    ...
                                    <div class="form__label">
                                        <input class="default_input" type="text" name="address[{{ $i }}]" value="{{ $branch->address }}"  placeholder="{{ __('store.branch_address') }}" />
                                        <label class="float__label" for="">{{ __('store.branch_address_val') }}</label>
                                    </div>
                                ...
                                <div class="maps">
                                    <div class="mb-3 main-inp-cont">
                                        <h6 class="fontBold mainColor font14">{{ __('store.branch_address_map') }}</h6>
                                        <div class="form__label">
                                            <input readonly class="default_input address" type="text" name="address_map[{{ $i }}]" value="{{ $branch->address_map }}"  placeholder="{{ __('store.branch_address_map') }}" />
                                            <label class="float__label" for="">{{ __('store.branch_address_map_val') }}</label>
                                        </div>
                                ...
                                <div class="mb-3 main-inp-cont">
                                    <h6 class="fontBold mainColor font14">{{ __('store.branch_record_number') }}</h6>
                                    <div class="form__label">
                                        <input class="default_input" name="comerical_record[{{ $i }}]" value="{{ $branch->comerical_record }}" type="number"  placeholder="{{ __('store.branch_record_number') }}" />
                                        <label class="float__label" for="">{{ __('store.branch_record_number_val') }}</label>
                                    </div>
                                    <div class="error_show error_comerical_record[{{ $i }}]"> </div>
                                </div>
                                <div class="mb-3 main-inp-cont">
                                    <h6 class="fontBold mainColor font14">{{ __('store.branch_images') }}</h6>
                                    <div class="form__label">
                                        <label for="filesNext4{{ $i }}_input" class="apload-img-reg">
                                            ...
                                            <div class="img-apload-title">{{ __('store.branch_images_val') }}</div>
                                        </label>
