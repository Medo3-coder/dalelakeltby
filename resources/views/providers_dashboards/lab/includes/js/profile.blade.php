    ...
    function deleteAccount(el){
        ...
        Swal.fire({
            ...
            if (result.isDenied) {
                ...
                $(el).ajaxSubmit({
                    url: '{{ route('lab.profile.store.delete') }}',
                    method:"POST",
                    data:{
                        _token:'{{ csrf_token() }}',
                        _method:'DELETE',
...
<script>
    function deletePermit(el){
        ...
        Swal.fire({
            icon: 'info',
            iconColor: '#2f71b3',
            title: '<h5 class="font_bold">'+ "{{ __('store.Do you want to remove the permit?') }}" +'</h5>',
            showDenyButton: true,
            showCancelButton: true,
            showConfirmButton: false,
            denyButtonText: '{{ __('store.delete') }}',
            ...
            if (result.isDenied) {
                ...
                $(el).ajaxSubmit({
                    url: '{{ route('lab.profile.permit.delete') }}',
                    method:"POST",
                    data:{
                        _token:'{{ csrf_token() }}',
                        _method:'DELETE',
...
<div class="branches">
      <div class="spe-append-map position-relative ">
        ...
        <input type="hidden" name="ids[${myCount}]" value="0">
              ...
              <div class="spe-append-map position-relative ">
                                    <div class="mb-3 main-inp-cont">
                                        <h6 class="fontBold mainColor font14">{{ __('doctor.lab.name') }}</h6>
                                        <div class="form__label">
                                            <input class="default_input" type="text" name="name[${myCount}]" value=""  placeholder="{{ __('doctor.lab.name_val') }}" />
                                            <label class="float__label" for="">{{ __('doctor.lab.name_val') }}</label>
                                        </div>
                                    </div>
                                ...
                                <div class="mb-3 main-inp-cont">
                                    <h6 class="fontBold mainColor font14">{{ __('doctor.lab.address') }}</h6>
                                    <div class="form__label">
                                        <input class="default_input" type="text" name="address[${myCount}]" value=""  placeholder="{{ __('doctor.lab.address_val') }}" />
                                        <label class="float__label" for="">{{ __('doctor.lab.address_val') }}</label>
                                    </div>
                                ...
                                <div class="maps">
                                    <div class="mb-3 main-inp-cont">
                                        <h6 class="fontBold mainColor font14">{{ __('doctor.lab.address_map') }}</h6>
                                        <div class="form__label">
                                            <input readonly class="default_input address-${myCount}" type="text" name="address_map[${myCount}]" value=""  placeholder="{{ __('doctor.lab.address_map_val') }}" />
                                            <label class="float__label" for="">{{ __('doctor.lab.address_map_val') }}</label>
                                        </div>
                                    ...
                                    <div class="mb-3 main-inp-cont">
                                    <h6 class="fontBold mainColor font14">{{ __('doctor.lab.comerical_record') }}</h6>
                                    <div class="form__label">
                                        <input class="default_input" name="comerical_record[]" value="" type="number"  placeholder="{{ __('doctor.lab.comerical_record_val') }}" />
                                        <label class="float__label" for="">{{ __('doctor.lab.comerical_record_val') }}</label>
                                    </div>
                    ...
                    <div class="mb-3 main-inp-cont">
                      <h6 class="fontBold mainColor font14">{{ __('doctor.lab.images') }}</h6>
                      <div class="form__label">
