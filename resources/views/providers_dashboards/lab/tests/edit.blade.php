    ...
    <main class="main-sec" id="main">
        <div class="container">
            ...
            <div class="card-white">
                ...
                <form action="{{ route('lab.medicalTests.update', $test->id) }}" method="POST" class="form"
                    ...
                    <div class="mb-3 main-inp-cont col-12 col-lg-8">
                        ...
                        <select name="lab_category_id" id="" class="default2-select gr">
                            ...
                            @foreach ($labCategories as $category)
                                <option {{ $category->id == $test->lab_category_id ? 'selected' : '' }}
                                    value="{{ $category->id }}">
                    ...
                    <div class="mb-3 main-inp-cont col-12 col-lg-8">
                        ...
                        <select name="sub_category_id" id="" class="default2-select gr">
                            ...
                            @foreach ($subCategories as $category)
                                <option {{ $category->id == $test->sub_category_id ? 'selected' : '' }}
