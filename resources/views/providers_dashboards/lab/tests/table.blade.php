<table class="table text-center" style="width: 100%">
    <thead class="table-head">
        <tr>
            ...
            <th class="font10">@lang('doctor.name')</th>
        ...
        @if ($tests->count() != 0)
            @foreach ($tests as $key => $test)
                <tr>
                    ...
                    <td class="font12">
                        <span class="fontBold">{{ $test->labSubCategory->name }}</span>
                    </td>
