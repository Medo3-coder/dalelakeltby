    ...
    <main class="main-sec" id="main">
        <div class="container">
            ...
            <div class="flex-top_card">
                ...
                <a href="{{ route('lab.medicalTests.tests.create',['test' => request()->test]) }}" class="add_new_test up"><i class="fa-solid fa-plus"></i>
...
@push('js')
    ...
    @include('admin.shared.filter_js', ['index_route' => route('lab.medicalTests.tests.index' ,['test' => request()->test])])
