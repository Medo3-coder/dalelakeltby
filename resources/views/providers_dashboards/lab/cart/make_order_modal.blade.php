<form action="{{ route('lab.orders.make') }}" data-success="$('#staticBackdrop').modal('show')" class="form"
    method="POST">
    @csrf
    ...
    <div class="modal-body no-border-bottom modal2-spe">
        ...
        <div class="make_order_modal_header">
            @include('providers_dashboards.lab.cart._make_order_modal_header')
        </div>
        ...
        <div class="mb-3 main-inp-cont">
            <h6 class="fontBold mainColor font14"> @lang('localize.lab_branch') </h6>
            <div class="form__label">
                <select name="lab_branch_id" class=" main_speciality default_input">
                    <option selected disabled>{{ __('admin.select') . ' ' . __('localize.lab_branch') }}</option>
            ...
            <div class="error_show error_lab_branch_id"> </div>
        </div>
        ...
        <div class="flex-card-2 mb-3 make_order_modal_footer">
            @include('providers_dashboards.lab.cart._make_order_modal_footer')
        </div>
