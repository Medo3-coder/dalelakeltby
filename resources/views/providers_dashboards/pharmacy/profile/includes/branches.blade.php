    ...
    <div class="modal-dialog modal-dialog-spe">
        <div class="modal-content">
            ...
            <div class="modal-body no-border-bottom modal1-spe">
                ...
                <form action="{{ route('pharmacy.profile.store.update') }}" method="POST" enctype="multipart/form-data" class="form">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="branches">
                            <div class="spe-append-map position-relative ">
                                <div class="mb-3 main-inp-cont">
                                    <h6 class="fontBold mainColor font14">{{ __('doctor.pharmacy.name') }}</h6>
                                    <div class="form__label">
                                        <input class="default_input" type="text" name="name[]" value="{{ $firstBranch->name }}"  placeholder="{{ __('doctor.pharmacy.name_val') }}" />
                                        <label class="float__label" for="">{{ __('doctor.pharmacy.name_val') }}</label>
                                    </div>
                                    <div class="error_show error_name[0]"> </div>
                                </div>
                            </div>
                            <div class="mb-3 main-inp-cont">
                                <h6 class="fontBold mainColor font14">{{ __('doctor.pharmacy.address') }}</h6>
                                <div class="form__label">
                                    <input class="default_input" type="text" name="address[]" value="{{ $firstBranch->address }}"  placeholder="{{ __('doctor.pharmacy.address_val') }}" />
                                    <label class="float__label" for="">{{ __('doctor.pharmacy.address_val') }}</label>
                                </div>
                                <div class="error_show error_address[0]"> </div>
                            </div>
                            <div class="maps">
                                <div class="mb-3 main-inp-cont">
                                    <h6 class="fontBold mainColor font14">{{ __('doctor.pharmacy.address_map') }}</h6>
                                    <div class="form__label">
                                        <input readonly class="default_input address" type="text" name="address_map[]" value="{{ $firstBranch->address_map }}"  placeholder="{{ __('doctor.pharmacy.address_map') }}" />
                                        <label class="float__label" for="">{{ __('doctor.pharmacy.address_map_val') }}</label>
                                    </div>
                            ...
                            <div class="mb-3 main-inp-cont">
                                <h6 class="fontBold mainColor font14">{{ __('doctor.pharmacy.comerical_record') }}</h6>
                                <div class="form__label">
                                    <input class="default_input" name="comerical_record[]" value="{{ $firstBranch->comerical_record }}" type="number"  placeholder="{{ __('doctor.pharmacy.comerical_record_val') }}" />
                                    <label class="float__label" for="">{{ __('doctor.pharmacy.comerical_record_val') }}</label>
                                </div>
                                <div class="error_show error_comerical_record[0]"> </div>
                            </div>
                            <div class="mb-3 main-inp-cont">
                                <h6 class="fontBold mainColor font14">{{ __('doctor.pharmacy.images') }}</h6>
                                <div class="form__label">
                                    <label for="filesNext19_input" class="apload-img-reg">
                                        ...
                                        <div class="img-apload-title">{{ __('doctor.pharmacy.images_val') }}</div>
                                    </label>
                            ...
                            <div class="branches">
                                ...
                                <div class="spe-append-map position-relative ">
                                    ...
                                    <div class="mb-3 main-inp-cont">
                                        <h6 class="fontBold mainColor font14">{{ __('doctor.pharmacy.name') }}</h6>
                                        <div class="form__label">
                                            <input class="default_input" type="text" name="name[{{ $i}}]" value="{{ $branch->name }}"  placeholder="{{ __('doctor.pharmacy.name_val') }}" />
                                            <label class="float__label" for="">{{ __('doctor.pharmacy.images_val') }}</label>
                                        </div>
                                ...
                                <div class="mb-3 main-inp-cont">
                                    <h6 class="fontBold mainColor font14">{{ __('doctor.pharmacy.address') }}</h6>
                                    <div class="form__label">
                                        <input class="default_input" type="text" name="address[{{ $i }}]" value="{{ $branch->address }}"  placeholder="{{ __('doctor.pharmacy.address_val') }}" />
                                        <label class="float__label" for="">{{ __('doctor.pharmacy.address_val') }}</label>
                                    </div>
                                ...
                                <div class="maps">
                                    <div class="mb-3 main-inp-cont">
                                        <h6 class="fontBold mainColor font14">{{ __('doctor.pharmacy.address_map') }}</h6>
                                        <div class="form__label">
                                            <input readonly class="default_input address" type="text" name="address_map[{{ $i }}]" value="{{ $branch->address_map }}"  placeholder="{{ __('doctor.pharmacy.address_map_val') }}" />
                                            <label class="float__label" for="">{{ __('doctor.pharmacy.address_map_address') }}</label>
                                        </div>
                                ...
                                <div class="mb-3 main-inp-cont">
                                    <h6 class="fontBold mainColor font14">{{ __('doctor.pharmacy.comerical_record') }}</h6>
                                    <div class="form__label">
                                        <input class="default_input" name="comerical_record[{{ $i }}]" value="{{ $branch->comerical_record }}" type="number"  placeholder="{{ __('doctor.pharmacy.comerical_record_val') }}" />
                                        <label class="float__label" for="">{{ __('doctor.pharmacy.comerical_record_val') }}</label>
                                    </div>
