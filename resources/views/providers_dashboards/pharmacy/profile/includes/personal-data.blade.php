    ...
    <div class="modal-dialog modal-dialog-spe">
        <div class="modal-content">
            ...
            <div class="modal-body no-border-bottom modal1-spe">
                ...
                <form action="{{ route('pharmacy.profile.update') }}" method="POST" enctype="multipart/form-data" class="form" data-type="profile">
                    @csrf
                    @method('PUT')
                    <div class="">
                        <div class="img-cont-spe">
                            <img src="{{ $pharmacy->image }}" alt="" id="change-profile">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-12">
                            <div class="mb-3 main-inp-cont">
                                ...
                                <div class="form__label">
                                    <input class="default_input" value="{{ $pharmacy->name }}" name="name" type="text"  placeholder="{{ __('store.name') }}" />
                        ...
                        <div class="col-lg-6 col-12">
                            ...
                            <div class="form__label overflowx-v input-g input-group-full age-date inp-cont-spe mb-3 code-country">
                                <input type="hidden" id="country_code" name="country_code" value="{{ $pharmacy->country_code }}">
                                <div class="flex-nums-s">
                                    <input
                                            type="tel"
                                            id="telephone"
                                            value="+{{ $pharmacy->country_code }}"
                                            name=""
                                    />
                                    <input class="placeholder-spe inp-spe num-inp-spe"  value="{{ $pharmacy->phone }}" name="phone" type="number"  placeholder="{{ __('store.phone_val') }}" />
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="mb-3 main-inp-cont">
                                ...
                                <div class="form__label">
                                    <input class="default_input" value="{{ $pharmacy->email }}" name="email" type="email"  placeholder="{{ __('store.email_val') }}" />
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="mb-3 main-inp-cont">
                                ...
                                <div class="form__label">
                                    <input class="default_input" value="{{ $pharmacy->identity_number }}" name="identity_number" type="number"  placeholder="{{ __('store.ID Number_val') }}" />
