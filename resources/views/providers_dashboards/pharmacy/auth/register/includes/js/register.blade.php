      ...
      <div class="spe-append-map">
                    ...
                    <div class="mb-3 main-inp-cont">
                        ...
                        <div class="form__label">
                            <input class="default_input" name="branches[${myCount}][name]" type="text" 
                                placeholder="@lang('localize.pe_branch_name')" />
        ...
        <div class="mb-3 main-inp-cont">
            <h6 class="fontBold mainColor font14">
                {{ __('store.branch_address') }}
        </h6>
                            <div class="form__label">
            <input class="default_input" name="branches[${myCount}}][address]" type="text"  placeholder="{{ __('store.branch_address_val') }}" />
                    ...
                    <h6 class="fontBold mainColor font14">
                      ...
                      <div class="form__label">
                        ...
                        <input class="default_input address-${myCount}" name="branches[${myCount}][address_map]" readonly type="text"
                            placeholder="{{ __('store.branch_address_map_val') }}t" />
...
{{-- 
<script>
    var latlng = new google.maps.LatLng(35.137879, -82.836914);
