    ...
    function deleteAccount(el){
        ...
        Swal.fire({
            ...
            if (result.isDenied) {
                ...
                $(el).ajaxSubmit({
                    url: '{{ route('pharmacy.profile.store.delete') }}',
                    method:"POST",
                    data:{
                        _token:'{{ csrf_token() }}',
                        _method:'DELETE',
    ...
    function deletePermit(el){
        ...
        Swal.fire({
            ...
            if (result.isDenied) {
                ...
                $(el).ajaxSubmit({
                    url: '{{ route('pharmacy.profile.permit.delete') }}',
                    method:"POST",
                    data:{
                        _token:'{{ csrf_token() }}',
                        _method:'DELETE',
              ...
              <div class="spe-append-map position-relative ">
                                    <div class="mb-3 main-inp-cont">
                                        ...
                                        <div class="form__label">
                                            <input class="default_input" type="text" name="name[${myCount}]" value=""  placeholder="{{ __('doctor.pharmacy.name_val') }}" />
                                ...
                                <div class="mb-3 main-inp-cont">
                                    ...
                                    <div class="form__label">
                                        <input class="default_input" type="text" name="address[${myCount}]" value=""  placeholder="{{ __('doctor.pharmacy.address_val') }}" />
                                ...
                                <div class="maps">
                                    <div class="mb-3 main-inp-cont">
                                        ...
                                        <div class="form__label">
                                            <input readonly class="default_input address-${myCount}" type="text" name="address_map[${myCount}]" value=""  placeholder="{{ __('doctor.pharmacy.address_map_val') }}" />
                                    ...
                                    <div class="form__label">
                                        <input class="default_input" name="comerical_record[]" value="" type="number"  placeholder="{{ __('doctor.pharmacy.comerical_record_val') }}" />
