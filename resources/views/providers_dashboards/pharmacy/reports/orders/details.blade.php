                ...
                <div class="inner-card">
                    ...
                    <div class="flex-inner-card">
                        <div class="right-inner-card">
                            <div class="inner-adress">@lang('localize.address') : شارع المتنبي بغداد</div>
                            <div class="inner-adress">@lang('localize.phone_number') : 02897862655</div>
                        </div>
                    ...
                    <div class="row-name">@lang('localize.pharmacy_address') : {{ $order->pharmacist->branches->first()->address }}</div>
