...
@section('content')
    ...
    <main class="main-sec" id="main">
        <div class="container">
            ...
            <div class="side-heading">
                ...
                <p>@lang('site.control_panel_welcom_message', ['user_name' => $doctor->name])</p>
            </div>
            ...
            <div class="card-white font-17">
                ...
                <div class="row">
                    <div class="col-lg-4 col-12 flex-info font_bold">
                        <div class="profile-in font_bold mt-3 mb-3">{{ __('store.name') }} : <span class="font-700">{{ $doctor->name }}</span></div>
                    </div>

                    <div class="col-lg-4 col-12 flex-info font_bold">
                        <div class="profile-in font_bold mt-3 mb-3">{{ __('translation.nickname') }} : <span class="font-700">{{ $doctor->nickname }}</span></div>
                    </div>

                    @if($singleCategory !== false)
                        <div class="col-lg-4 col-12 flex-info font_bold">
                            <div class="profile-in font_bold mt-3 mb-3">{{ __('translation.category') }} : <span class="font-700">{{ $singleCategory->name }}</span></div>
                        </div>
                    @endif

                    <div class="col-lg-4 col-12 flex-info font_bold">
                        <div class="profile-in font_bold mt-3 mb-3">{{ __('translation.age') }} : <span class="font-700">{{ $doctor->age . ' ' . __('translation.years') }}</span></div>
                    </div>
                    <div class="col-lg-4 col-12 flex-info font_bold">
                        <div class="profile-in font_bold mt-3 mb-3">{{ __('store.Mobile number') }} :  <span class="font-700">{{ $doctor->fullPhone }}</span></div>
                    </div>

                    <div class="col-lg-4 col-12 flex-info font_bold">
                        <div class="profile-in font_bold mt-3 mb-3">{{ __('translation.sub_category') }} : <span class="font-700">{{ $doctor->category->name }}</span></div>
                    </div>
                    ...
                    <div class="col-lg-4 col-12 flex-info font_bold">
                        <div class="profile-in font_bold mt-3 mb-3">{{ __('store.email') }} : <span class="font-700">{{ $doctor->email }}</span></div>
                    </div>



                    <div class="col-lg-4 col-12 flex-info font_bold">
                        <div class="profile-in font_bold mt-3 mb-3">{{ __('translation.experience_years') }} : <span class="font-700">{{ $doctor->experience_years . ' ' . __('translation.years') }}</span></div>
                    </div>


                    <div class="col-lg-6 col-12 flex-info font_bold">
                        <div class="profile-in font_bold mb-3">{{ __('store.ID Number') }} : <span class="font-700">{{ $doctor->identity_number }}</span></div>
                    </div>
                </div>
            ...
            <div class="card-white font-17">
                ...
                @empty
                @endforelse
                <form action="{{ route('doctor.profile.permit.update') }}" class="form" data-type="profile" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="flex-photos ">
                        ...
                        <label for="sin-up">
                            <div class="right-ph"><img src="{{ $doctor->graduation_certification_image }}" alt="">
                        ...
                        <div class="left-ph">
                            ...
                            <div class="color-main">
                                <a href="{{ $doctor->graduation_certification_pdf }}" target="_blank">
                                    <img src="{{ asset('/') }}dashboard/imgs/pdf.png" alt="">
                                </a>
                                <div class="mt-3"></div>
                    ...
                    <div class="flex-photos ">
                        ...
                        <label for="sin-up2">
                            <div class="right-ph"><img src="{{ $doctor->practice_certification_image }}" alt="">
                        ...
                        <div class="left-ph">
                            ...
                            <div class="color-main">
                                <a href="{{ $doctor->practice_certification_pdf }}" target="_blank">
                                    <img src="{{ asset('/') }}dashboard/imgs/pdf.png" alt="">
                                </a>
                                <div class="mt-3"></div>
                    ...
                    <div class="flex-photos ">
                        ...
                        <label for="sin-up3">
                            <div class="right-ph"><img src="{{ $doctor->experience_certification_image }}" alt="">
                        ...
                        <div class="left-ph">
                            ...
                            <div class="color-main">
                                <a href="{{ $doctor->experience_certification_pdf }}" target="_blank">
                                    <img src="{{ asset('/') }}dashboard/imgs/pdf.png" alt="">
                                </a>
                                <div class="mt-3"></div>
            ...
            <div class="card-white font-17">
                <div class="top-card-flex">
                    <h4 class="font_bold no-border-bottom font-17">{{ __('translation.doctor_details') }}</h4>
                    <a href="#" data-toggle="modal" data-target="#exampleModal2"><i class="fa-solid fa-pen-to-square"></i></a>
                </div>
                <div class="profile-in">{{ __('translation.doctor_address') }} : <span>{{ $firstBranch->address }}</span></div>
                <div class="profile-in">{{ __('translation.doctor_address_map') }} : <span>{{ $firstBranch->address_map }}</span></div>
                <div class="profile-in">{{ __('translation.doctor_record_number') }} : <span>{{ $firstBranch->comerical_record }}</span></div>
                ...
                <h4 class="font_bold mt-3 mb-3">{{ __('translation.doctor_images') }}</h4>
    ...
    @include('providers_dashboards.doctor.profile.includes.personal-data')
    @include('providers_dashboards.doctor.profile.includes.permit')
    @include('providers_dashboards.doctor.profile.includes.branches')
...
@push('js')
    ...
    @include('providers_dashboards.doctor.includes.js.profile')
    ...
    <script>
        ...
        function getSubSpecialities(){
            var el = $('.main_speciality');
            $.ajax({
                url: '{{ url('doctor/profile/sub-specialities') }}' + '/' + el.val(),
                method: 'get',
                dataType: 'json',
                success: (response) => {
