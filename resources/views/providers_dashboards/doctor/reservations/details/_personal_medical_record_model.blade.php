<!-- Modal 4 -->
<div class="modal fade" id="exampleModal4" tabindex="-1" aria-labelledby="exampleModal3Label" aria-hidden="true">
    <div class="modal-dialog modal-dialog-spe">
        <div class="modal-content">
            ...
            <div class="modal-body no-border-bottom modal2-spe font-16 print-doctor">
                <h5 class="font_bold mb-3">@lang('doctor.personal_records')</h5>


                @forelse ($finishedReservationsPersonal as $finishedReservation)
                    <h5 class="font_bold mb-3">@lang('doctor.medical_receipt')</h5>
                    <div class="print-container">
                        <img class="ro-img-spe" src="{{ $finishedReservation->medicalRecord?->ragite?->image }}" alt="">
                        <img class="abb-img-spe" src="{{ $finishedReservation->doctor?->category?->image }}" alt="">
                        ...
                        <div class="abs-contain px-3">
                            ...
                            <div class="first-flex1">
                                <div class="first-flex1-right text-secondary">
                                    <div class="line11"> @lang('site.paient_name') : <span>{{ $finishedReservation->name }}</span></div>
                                    <div class="line11">@lang('admin.date') <span>{{ \Carbon\Carbon::parse($finishedReservation->date)->isoFormat('MMMM D YYYY') }}</span></div>
                                    <div class="line11">@lang('admin.age') <span>{{ $finishedReservation->age }}</span></div>
                                </div>
                                ...
                                <div class="first-flex1-left text-center text-secondary">
                                    <div class="line11 black-im">@lang('doctor.dr')
                                        <span>{{ $finishedReservation->doctor?->name }}</span></div>
...
{{--                                            @dd($finishedReservation->medicalRecord?->medicalRecordMedicans)--}}
                            ...
                            <div class="line11 line2211">@lang('admin.phone'):
                                <span>{{ $finishedReservation->doctor?->phone }}</span></div>
                        </div>
