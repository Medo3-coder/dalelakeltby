    ...
    function appendAll() {
      ...
      <div class="spe-append-map">
                    ...
                    <div class="mb-3 main-inp-cont">
                        <h6 class="fontBold mainColor font14">@lang('localize.clinic_name')</h6>
                        <div class="form__label">
                            <input class="default_input" name="clinics[${myCount}][name]" type="text" required=""
                                placeholder="@lang('localize.pe_clinic_name')" />
                            <label class="float__label" for="">@lang('localize.pe_clinic_name')</label>
                        </div>
                        <div class="error_show error_clinics.${myCount}.name"> </div>
                    </div>
                    <div class="mb-3 main-inp-cont">
                        <h6 class="fontBold mainColor font14">@lang('localize.detection_price')</h6>
                        <div class="form__label">
                            <input class="default_input" name="clinics[${myCount}][detection_price]" type="text" required=""
                                placeholder="@lang('localize.pe_detection_price')" />
                            <label class="float__label" for="">@lang('localize.pe_detection_price')</label>
                        </div>
                        <div class="error_show error_clinics.${myCount}.detection_price"> </div>
                    </div>
                    ...
                    <div class="mb-3 main-inp-cont">
                        <div class="maps">
                            <div class="mb-3 main-inp-cont">
                                <h6 class="fontBold mainColor font14">
                                    @lang('localize.clinic_location_on_map')
                                </h6>
                                <div class="form__label">
                                    <input type="hidden" name="clinics[${myCount}][lat]" class="lat-${myCount}" value="31.04035945880287">
                                    <input type="hidden" name="clinics[${myCount}][lng]" class="lng-${myCount}" value="31.37892723083496">
                                    <input class="default_input address-${myCount}" name="clinics[${myCount}][address]" readonly type="text"
                        ...
                        <div class="error_show error_clinics.${myCount}.lat"> </div>
                        <div class="error_show error_clinics.${myCount}.lng"> </div>
                        <div class="error_show error_clinics.${myCount}.address"> </div>
                    </div>


                    <div class="mb-3 main-inp-cont">
                      <h6 class="fontBold mainColor font14">
                        @lang('localize.clinic_comerical_number')
                      </h6>
                      <div class="form__label">
                        <input
                          class="default_input"
                          ...
                          name="clinics[${myCount}][comerical_record]"
                        />
                        <label class="float__label" for="">@lang('localize.pe_clinic_comerical_number')</label>

                      </div>
                      <div class="error_show error_clinics.${myCount}.comerical_record"> </div>
                    </div>
                    
                    <div class="mb-3 main-inp-cont">
                      <h6 class="fontBold mainColor font14">
                        @lang('localize.clinic_images')
                    </h6>
                      <div class="form__label">
                      ...
                      <div class="error_show error_clinics.${myCount}.images"> </div>
                              ...
                              <div class="row g-2">
                                  <div class="input-work col-6 col-sm-6 col-md-4">
                                      <div class="input-icon">
                                          <select name="clinics[${myCount}][dates][0][day]" class="default_input">
                                      ...
                                      <div class="error_show error_clinics.${myCount}.dates.0.day"> </div>

                                  </div>
                                  <div class="input-work col-6 col-sm-6 col-md-4">
                                      <input type="text" name="clinics[${myCount}][dates][0][from]" placeholder="@lang('localize.from')"
                                          class="from-date" id="" />
                                      <label class="add-photo" for="time1">
                                          <i class="fa-regular fa-clock"></i>
                                      </label>
                                      <div class="error_show error_clinics.${myCount}.dates.0.from"> </div>

                                  </div>
                                  <div class="input-work col-6 col-sm-6 col-md-4">
                                      <input type="text" name="clinics[${myCount}][dates][0][to]" placeholder="@lang('localize.to')"
                                          class="to-date" id="" />
                                      <label class="add-photo" for="time2">
                                          <i class="fa-regular fa-clock"></i>
                                      </label>
                                      <div class="error_show error_clinics.${myCount}.dates.0.to"> </div>
                ...
                <div class="error_show error_clinics.${myCount}.dates"> </div>
    ...
    function appendDateMain(dateMain, index) {
        ...
        dateRow.innerHTML = `
                    <div class="row g-2 relative-parent">
                      <div class="input-work col-6 col-sm-6 col-md-4">
                              <div class="input-icon">
                                  <select name="clinics[${index}][dates][${datesCounter}][day]" class="default_input">
                                      <option value="saturday">@lang('localize.sat')</option>
                                      <option value="sunday">@lang('localize.sun')</option>
                                      <option value="monday">@lang('localize.mon')</option>
                                      <option value="tuesday">@lang('localize.tue')</option>
                                  ...
                                  <div class="error_show error_clinics.${index}.dates.${datesCounter}.day"> </div>

                              </div>
                          </div>
                          <div class="input-work col-6 col-sm-6 col-md-4">
                              <input type="text" name="clinics[${index}][dates][${datesCounter}][from]" placeholder="@lang('localize.from')"
                                  class="from-date" id="" />
                              <label class="add-photo" for="time1">
                                  <i class="fa-regular fa-clock"></i>
                              </label>
                              <div class="error_show error_clinics.${index}.dates.${datesCounter}.from"> </div>

                          </div>
                          <div class="input-work col-6 col-sm-6 col-md-4">
                              <input type="text" name="clinics[${index}][dates][${datesCounter}][to]" placeholder="@lang('localize.to')"
                                  class="to-date" id="" />
                              <label class="add-photo" for="time2">
                                  <i class="fa-regular fa-clock"></i>
                              </label>
                              <div class="error_show error_clinics.${index}.dates.${datesCounter}.to"> </div>
