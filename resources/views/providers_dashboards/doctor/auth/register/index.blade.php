                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-md-9">
                        <div class="wizard">
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li role="presentation" class="disabled tabClass">
                                        <a href="#step3" data-toggle="tab" aria-controls="step3" role="tab"
                                            ...
                                            <img class="tab-img" src="{{ asset('/site') }}/imgs/Group 83214.png"
                                                alt="" />
                                            <span class="round-tab">@lang('localize.clinic_data')</span></a>
                                    </li>
                                    <li role="presentation" class="disabled tabClass">
                            ...
                            <form role="form" action="{{ route('doctor.postRegister') }}" method="POST"
                                class="login-box form" enctype="multipart/form-data">
                                @csrf
                                <div class="tab-content" id="main_form">
                                    @include('providers_dashboards.doctor.auth.register.includes.html.register.personal-data')
                                    @include('providers_dashboards.doctor.auth.register.includes.html.register.qualifications')
                                    @include('providers_dashboards.doctor.auth.register.includes.html.register.clinic-data')
                                    @include('providers_dashboards.doctor.auth.register.includes.html.register.password')
...
@section('js')
    ...
    {{-- @include('providers_dashboards.doctor.auth.register.includes.js.map' ,['draggable' => true]) --}}

    <script src="{{ asset('/site/') }}/js/jquery.fancybox.min.js"></script>

    @include('providers_dashboards.doctor.auth.register.includes.js.register')


    @include('providers_dashboards.doctor.auth.register.includes.js.formAjaxRegister')

    <script>
        $('.main_speciality').on('change', function() {
            $.ajax({
                url: '{{ url('doctor/sub-specialities') }}' + '/' + $(this).val(),
                method: 'get',
                dataType: 'json',
                success: (response) => {
