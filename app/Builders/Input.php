...
class Input {
    ...
    static function createArEnTextarea(string $title_ar, string $title_en ,string $title_Kur) {
        $input = new InputBuilder('textarea_ar_en', ['ar' => $title_ar, 'en' => $title_en ,'kur' => $title_Kur]);
        return $input;
    }
    /******************** end create inputs of the default html ************************/

    // create input type = any but the default is text create two inputs [ar] ,[en]
    static function createArEnInput(string $title_ar, string $title_en ,string $title_Kur) {
        $input = new InputBuilder('input_ar_en', ['ar' => $title_ar, 'en' => $title_en ,'kur' => $title_Kur]);
        return $input->type('text');
    }
